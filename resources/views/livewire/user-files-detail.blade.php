<div>
    ...
    <x-modal id="user-files-modal" wire:model="showingModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.group class="col-sm-12 col-md-6">
                        <x-inputs.select
                            name="file.file_type_id"
                            label="File Type"
                            wire:model="file.file_type_id"
                        >
                            <option value="null" disabled>Please select the File Type</option>
                            @foreach($userFileTypes as $value => $label)
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.user_files.inputs.file_name')
                    </th>
                    <th class="text-left">
                        @lang('crud.user_files.inputs.file_type_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
            <tbody class="text-gray-600">
                ...
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="text-left">
                        {{ optional($file->fileType)->mime_type ?? '-' }}
                    </td>
